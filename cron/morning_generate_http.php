<?php
/**
 * HTTP-accessible Morning Auto-Generate Endpoint
 * This file can be called via HTTP GET/POST from cron-job.org
 * 
 * URL: https://kolektrash.systemproj.com/cron/morning_generate_http.php
 */
...
$output = [];
$output[] = writeLog("=========================================");
$output[] = writeLog("MORNING GENERATION (6:00 AM) - HTTP");
...
if ($result && $result['success']) {
    $output[] = writeLog("SUCCESS: Morning tasks and routes generated");
    ...
    $output[] = writeLog("Morning generation completed");
    $output[] = writeLog("=========================================");
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Morning generation completed successfully',
        'result' => $result,
        'log' => $output
    ]);
} else {
