...
export default function Feedback() {
          ...
          if (userDetails.status === 'success' && userDetails.data) {
            ...
            const mergedUser = {
              ...
              barangay_name:
                data.barangay_name ||
                data.barangay ||
                parsedUser.barangay_name ||
                parsedUser.barangay,
            };
            setUser(mergedUser);
          }
        } catch (detailsError) {
          console.warn('Barangay head feedback additional details fetch error:', detailsError);
        }
      } catch (e) {
  ...
  const handleSubmit = (event) => {
    ...
    try {
      ...
      const barangayName = user.barangay_name || user.barangay;
      ...
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-4 sm:mb-6">
          ...
          <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
            Share how the MENRO service is working for your barangay.
          </p>
